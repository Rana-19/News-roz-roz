...
const HomePage = () => {
  ...
  const getNews = async () => {
    ...
    const newsData = await fetchNews("India")
  ...
  return (
    <div className={isDark ? 'd-flex flex-row bg-dark justify-content-around my-2' : 'd-flex flex-row  justify-content-around my-2'}>
      ...
      <div className='container' style={{ width: "33%", overflow: "scroll", height: "400px", background: "radial-gradient(circle, rgba(238,174,202,1) 0%, rgba(106,164,232,1) 100%)" }}>
        <Weather />
      </div>
